![img](https://mmbiz.qpic.cn/mmbiz_gif/iappkPENyMQ8h9Kt2sHul0eeIBzuXoqiaOeNa1MK8acibyDKwOWCuQPnibYzeBZqibic5Fa9gsc0yCC3hLFLofkPEEAA/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)

**前言**

你是否在为系统的数据库来一波大流量就几乎打满CPU，日常CPU居高不下烦恼？**你是否在各种NoSql间纠结不定，到底该选用那种最好？**今天的你就是昨天的我，这也是写这篇文章的初衷。

这篇文章是我好几个月来一直想写的一篇文章，也是一直想学习的一个内容，作为互联网从业人员，我**们要知道关系型数据库（MySql、Oracle）无法满足我们对存储的所有要求，因此对底层存储的选型，对每种存储引擎的理解非常重要。**同时也由于过去一段时间的工作经历，对这块有了一些更多的思考，想通过自己的总结把这块写出来分享给大家。
...
![img](https://mmbiz.qpic.cn/mmbiz_png/yH2gnJbDwoEJN5Qca9mibbWHcDmER0PicnghTuicgXZn8ts2s0X3EXOmricU9J9IJb8j25gHo9dibusH7yDfOOAicozw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/yH2gnJbDwoEJN5Qca9mibbWHcDmER0PicnV7OaMSeO5ye7Zze9lQ6ttiaEfRgTtNoQVLDHbtBej3QibKqVhdRWgDNA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/yH2gnJbDwoEJN5Qca9mibbWHcDmER0PicnK3y5B9axeFiatN9cwLfnvFEoibt6VbFPBZNKrWjyvPO7hyYyYVgI162g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/yH2gnJbDwoEJN5Qca9mibbWHcDmER0PicnehKvDfOEuLGq3B8v0zU6xzLkXvOXzHKaZHS97oha0SmpN6GEwuZLNQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/yH2gnJbDwoEJN5Qca9mibbWHcDmER0PicneMhiayCicIl6mF96gygO7wmWicnyDbGEQXste2WyojQZvOnQ5h4UoxkMw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
